...
//scrollsnap.js
!function(a){function b(a,b,c){var d,e,f,g,h;return function(){f=this,e=arguments,g=new Date;var i=function(){var j=new Date-g;b>j?d=setTimeout(i,b-j):(d=null,c||(h=a.apply(f,e)))},j=c&&!d;return d||(d=setTimeout(i,b)),j&&(h=a.apply(f,e)),h}}a.fn.scrollsnap=function(c){var d=a.extend({direction:"y",snaps:"*",proximity:12,offset:0,duration:200,latency:250,easing:"swing",onSnapEvent:"scrollsnap",onSnap:function(){},onSnapWait:50},c),e="x"===d.direction?"Left":"Top";return this.each(function(){var c=this,f=a(c);if(void 0!==c["scroll"+e])f.css("position","relative"),f.bind("scrollstop",{latency:d.latency},function(){var h=null,i=d.proximity+1;if(f.find(d.snaps).each(function(){var a=this,b=Math.abs(a["offset"+e]+d.offset-c["scroll"+e]);b<=d.proximity&&i>b&&(h=a,i=b)}),h){var j=h["offset"+e]+d.offset,k={};k["scroll"+e]=j,f["scroll"+e]()!=j&&f.animate(k,d.duration,d.easing,b(function(){var b=a(h);d.onSnap&&d.onSnap(b),b.trigger(d.onSnapEvent)},d.onSnapWait))}});else if(c.defaultView){var g=function(){var h=null,i=d.proximity+1;if(f.find(d.snaps).each(function(){var b=this,f=a(b),g=Math.abs(f.offset()[e.toLowerCase()]+d.offset-c.defaultView["scroll"+d.direction.toUpperCase()]);g<=d.proximity&&i>g&&(h=b,i=g)}),h){var j=a(h),k=j.offset()[e.toLowerCase()]+d.offset,l={};l["scroll"+e]=k,f["scroll"+e]()!=k&&a("html, body").animate(l,d.duration,d.easing,b(function(){d.onSnap&&d.onSnap(j),j.trigger(d.onSnapEvent)},d.onSnapWait))}};f.bind("scrollstop",{latency:d.latency},g),a(window).bind("resize",{latency:d.latency},g)}})}}(jQuery);
